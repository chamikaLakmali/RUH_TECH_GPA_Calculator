...
public class ET31 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Introduction to Robotics ");
        bPanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 390, 20));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Electrical Power Systems");
        bPanel.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 350, 20));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setText("Electrical/Electronic and Mechanical Equipment Maintenance");
        bPanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 380, 20));

        sub3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        sub3.setText("Computer Hardware and Network Maintenance");
        bPanel.add(sub3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 330, 50));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel7.setText("Circuit Analysis & Faults Diagnosis");
        ...
        jLabel8.setText("Workshop Technology III");
        ...
        jLabel2.setText("Level 03 Semester 1 - Department of ET");
        ...
        jLabel9.setText("Welding Techniques");
        ...
        jLabel10.setText("Safety and Risk Management");
        ...
        bPanel.add(error, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, 380, -1));

        jLabel11.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel11.setText("Ethics for Technologists");
        ...
        jLabel12.setText("English V ");
        bPanel.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 330, 20));
        ...
        bPanel.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 520, 100, -1));

        jComboBox10.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jComboBox10.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Grade", "A+", "A", "A-", "B+", "B", "B-", "C+", "C", "C-", "D+", "D", "E", "E*", "F" }));
        bPanel.add(jComboBox10, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 430, 300, -1));

        jScrollPane1.setViewportView(bPanel);

        panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 760, 370));
