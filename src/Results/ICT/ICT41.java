...
public class ICT41 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        save.setText("ADD");
        bPanel.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, 100, -1));

        error.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        error.setForeground(new java.awt.Color(255, 0, 51));
        bPanel.add(error, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 290, 430, 20));
